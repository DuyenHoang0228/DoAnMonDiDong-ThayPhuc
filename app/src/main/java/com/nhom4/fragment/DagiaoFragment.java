...
public class DagiaoFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_dagiao, container, false);
        ...
        donHangs.add(new DonHang(R.drawable.giohang_sp1, "Thương hiệu: Virbac", "Gel Dinh Dưỡng Cho Chó Mèo Còi Cọc Virbac Nutri Plus 120g – Pháp", "Số lượng sản phẩm: 3", "Thành tiền: 190.000 VND"));
        donHangs.add(new DonHang(R.drawable.giohang_sp1, "Thương hiệu: Virbac", "Gel Dinh Dưỡng Cho Chó Mèo Còi Cọc Virbac Nutri Plus 120g – Pháp", "Số lượng sản phẩm: 3", "Thành tiền: 190.000 VND"));
        adapter = new AdapterDSDonmua(getActivity(), R.layout.donhangdagiao_id, donHangs);
        ListView lv = (ListView)rootView.findViewById(R.id.lv_dagiao);
