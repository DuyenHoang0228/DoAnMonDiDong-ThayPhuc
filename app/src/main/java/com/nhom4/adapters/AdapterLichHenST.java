...
public class AdapterLichHenST extends RecyclerView.Adapter<AdapterLichHenST.MyView>{
    ...
    public AdapterLichHenST(List<LichHen> lichhens) {
        this.lichhens = lichhens;
    }

    @NonNull
    @Override
    public AdapterLichHenST.MyView onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        // Nạp layout của file blog_id vào LayoutInflater
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.lichhen_saptoi_id, parent, false);
